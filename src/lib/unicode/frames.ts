...
export const FRAMES: FrameDefinition[] = [
  ...
  // ==================== ANIME & MANGA ====================
  { id: 'an-1', prefix: '꧁☬', suffix: '☬꧂', category: 'anime', name: 'Sharingan Seal' },
  { id: 'an-2', prefix: '★彡', suffix: '彡★', category: 'anime', name: 'Ninja Shuriken' },
  { id: 'an-3', prefix: '亗', suffix: '亗', category: 'anime', name: 'King of Curses' },
  { id: 'an-4', prefix: '꧁༒', suffix: '༒꧂', category: 'anime', name: 'Shinigami Aura' },
  { id: 'an-5', prefix: '★', suffix: '★', category: 'anime', name: 'Dragon Star' },
  { id: 'an-6', prefix: '☬', suffix: '☬', category: 'anime', name: 'Chakra Vortex' },
  { id: 'an-7', prefix: '彡', suffix: '彡', category: 'anime', name: 'Wind Breathing' },
  { id: 'an-8', prefix: '꧁⚡', suffix: '⚡꧂', category: 'anime', name: 'Thunder Breathing' },
  { id: 'an-9', prefix: '꧁✿', suffix: '✿꧂', category: 'anime', name: 'Flower Breathing' },
  { id: 'an-10', prefix: '꧁🌸', suffix: '🌸꧂', category: 'anime', name: 'Sakura Hashira' },
  { id: 'an-11', prefix: '꧁🏴☠️', suffix: '🏴☠️꧂', category: 'anime', name: 'Straw Hat Pirate' },
  { id: 'an-12', prefix: '꧁☠', suffix: '☠꧂', category: 'anime', name: 'Tokyo Ghoul' },
  { id: 'an-13', prefix: '⚔️ ', suffix: ' ⚔️', category: 'anime', name: 'Santoryu Blades' },
  { id: 'an-14', prefix: '炎 ', suffix: ' 炎', category: 'anime', name: 'Flame Hashira' },
  { id: 'an-15', prefix: '鬼 ', suffix: ' 鬼', category: 'anime', name: 'Demon Upper Moon' },
  { id: 'an-16', prefix: '影 ', suffix: ' 影', category: 'anime', name: 'Shadow Monarch' },
  { id: 'an-17', prefix: '刃 ', suffix: ' 刃', category: 'anime', name: 'Nichirin Blade' },
  { id: 'an-18', prefix: '⚡ ', suffix: ' ⚡', category: 'anime', name: 'Chidori Spark' },
  { id: 'an-19', prefix: '々 ', suffix: ' 々', category: 'anime', name: 'Kurikaeshi' },
  { id: 'an-20', prefix: '乂 ', suffix: ' 乂', category: 'anime', name: 'Samurai Cross' },
];
